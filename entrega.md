...
**Carpeta Ciudadana**: Sistema nacional de gestión de documentos digitales para Colombia.
...
- https://github.com/edwaraco/carpetaCiudadana
- Draft Docs: https://github.com/edwaraco/carpetaCiudadana/tree/main/docs
...
1. **Preparación:** Encolar documentos que lleguen durante el proceso
2. **Desregistro:** Desregistrar ciudadano del operador origen usando `/apis/unregisterCitizen`
3. **Transferencia:** Transferir datos P2P al operador destino usando su `transferAPIURL`
4. **Registro:** Registrar ciudadano en operador destino usando `/apis/registerCitizen`
5. **Entrega:** Entregar documentos en cola al nuevo operador
6. **Validación:** Confirmar integridad de todos los datos transferidos

**Fuente:** Swagger MinTIC - combinación de endpoints de registro/desregistro + DDD análisis - "Impacto de portabilidad en documentos en tránsito"
...
# Requisitos no Funcionales (vs QoS)
...
## 1. Disponibilidad y Resiliencia (prioridad)
...
## 3. Rendimiento y Latencia (prioridad)
...
El avance del segundo diagrama C4 puede encontrarse aquí:
- https://github.com/edwaraco/carpetaCiudadana/blob/main/docs/c4_diagrams.md#c4-level-2-container-diagram

## Diagrama de Secuencia

Algunos diagramas de secuencia hechos de antemano con nuestro entendimiento pueden encontrarse aquí:
- https://github.com/edwaraco/carpetaCiudadana/blob/main/docs/c4_diagrams.md#diagramas-de-secuencia---5-escenarios
...
Backlog:
  - https://github.com/users/edwaraco/projects/2/views/2

> Todo se manejó como PRs directamente, en sus decripciones está toda la información pertinente a la funcionalidad que aportaban

Algunas definiciones de las funcionalidades se hicieron directamente en los ADR también, junto a sus respectivos diagramas y flujos.
- https://github.com/edwaraco/carpetaCiudadana/tree/main/docs/ADR

## Diagrama de Componentes (Logicos y Tecnicos)

### Diagrama de Componenetes Lógico
![Imagen de WhatsApp 2025-11-08 a las 12 42 57_8e794762](https://github.com/user-attachments/assets/b25b26ff-3b17-4f60-ad28-040767e397cb)

### Diagrama de Componentes Técnico
![Imagen de WhatsApp 2025-11-08 a las 12 31 55_bd244ee2](https://github.com/user-attachments/assets/cb3d4d60-f5b0-4550-a4f4-bd4b225d67e2)
...
## Diagrama de Secuencia de los al menos 3 operaciones de la solución (Ajusutar los que tenemos actualmente)

### Registro de Documentos

**Descripción**

Proceso de subida de documentos en el sistema Carpeta Ciudadana. El ciudadano envía un archivo que se almacena en MinIO, se registran los metadatos en DynamoDB, y se publica un evento para procesamiento posterior.
...
|------------|-----------|---------|
| **carpeta-ciudadana-service** | Java/Spring Boot | API REST para gestión de documentos |
| **DynamoDB** | NoSQL Database | Almacena metadatos y auditoría |
| **MinIO** | Object Storage (S3) | Almacena archivos físicos |
| **RabbitMQ** | Message Broker | Publica eventos para procesamiento asíncrono |
...
Los registros de toma de decisiones de Arquitectura quedaron guardados en https://github.com/edwaraco/carpetaCiudadana/tree/main/docs/ADR, este contiene tanto las asociadas para el despliegue como la selección de patrones de Arquitectura y Tecnologias implementadas.
